...
# Configuring Logger to Use CloudWatch ---------- Disabled to save on spend
...
def init_rollbar():
    ...
    rollbar.init(
        # access token
<<<<<<< HEAD
        'f6bc037f315a43729231fa200ec1f86f',
=======
        'rollbar_access_token',
>>>>>>> 8716c8a (Delete access token)
        # environment name
        'production',
...
# Error Logging ---------- Disabled to save on spend
# @app.after_request
